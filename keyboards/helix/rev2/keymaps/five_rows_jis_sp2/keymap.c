...
[_BASE] = LAYOUT_kc( \
  ...
  //|------+------+------+------+------+------+------+------+------+------+------+------+------+------|
       LSFT,     Z,     X,     C,     V,     B,  RBRC,  BSLS,     N,     M,  COMM,   DOT,    UP,   ENT,\
  //|------+------+------+------+------+------+------+------+------+------+------+------+------+------|
      LCTRL,  LALT,  LGUI,  MLAD,  MLLO,  BSPC,   SPC,  MINS,   SPC,  MLRA,   APP,  LEFT,  DOWN,  RGHT \
  //`-------------------------------------------------------------------------------------------------'
  ),
  ...
  //|------+------+------+------+------+------+------+------+------+------+------+------+------+------|
      _____, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX, XXXXX,     0,     1,     2,     3,   DOT,  SLSH,\
  //|------+------+------+------+------+------+------+------+------+------+------+------+------+------|
