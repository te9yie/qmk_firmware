 ...
 */
[0] = LAYOUT( \
    KC_Q,   LALT_T(KC_W),KC_E,KC_R, KC_T,   KC_Y,   KC_U,   KC_I,   RALT_T(KC_O),KC_P,
...
/*
 * ,----------------------------------.           ,----------------------------------.
 * |   1  |Alt/2 |   3  |   4  |   5  |           |   6  |   7  |   8  |Alt/9 |   0  |
 * |------+------+------+------+------|           |------+------+------+------+------|
 * |Ctl/` |      | Del  |      |      |           | BkSp |Enter | Tab  | Esc  |Ctl/' |
 * |------+------+------+------+------|           |------+------+------+------+------|
 * |      |      |      |      |      |           |   -  |   =  |   [  |   ]  |   \  |
 * `-------------+------+------+------|           |------+------+------+------+------'
 *               |      |      |      |           |      |      |      |
 ...
 */
[1] = LAYOUT( \
    KC_1,   LALT_T(KC_2),KC_3,KC_4, KC_5,   KC_6,   KC_7,   KC_8,   RALT_T(KC_9),KC_0,
    LCTL_T(KC_GRV),KC_TRNS,KC_DEL,KC_TRNS,KC_TRNS,KC_BSPC,KC_ENT,KC_TAB,KC_ESC,RCTL_T(KC_QUOT),
...
[2] = LAYOUT( \
    ...
    KC_TRNS,KC_TRNS,KC_TRNS,KC_LSFT,KC_TRNS,KC_LEFT,KC_DOWN,KC_UP,  KC_RGHT,KC_TRNS,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,
                    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS
),
...
[3] =  LAYOUT( \
    ...
    KC_TRNS,KC_TRNS,KC_TRNS,KC_LSFT,KC_TRNS,KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10,
